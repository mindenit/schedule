	...
	<Teleport to="body">
		<AnimatePresence>
			<motion.div
				...
				class="fixed bottom-24 left-1/2 z-50 w-[calc(100vw-2rem)] max-w-lg -translate-x-1/2
					px-0 md:bottom-6"
			>
				<div
					class="border-border bg-card flex flex-col gap-3 rounded-xl border p-4 shadow-lg
				...
				>
					...
					<div class="min-w-0 flex-1">
						...
						<p class="text-muted-foreground mt-0.5 text-xs leading-relaxed">
							...
							застосунком. Жодної реклами, жодного продажу даних. Відмова не впливає
							на роботу.
						</p>
					</div>
