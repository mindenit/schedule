...
/**
 * ShinyText — animated metallic shine sweep over text.
 *
 * Scaffolded from vue-bits (https://vue-bits.dev/text-animations/shiny-text),
 * source: https://github.com/DavidHDev/vue-bits/blob/main/src/content/TextAnimations/ShinyText/ShinyText.vue
